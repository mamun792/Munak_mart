                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="best-product-box">
                                                        <div class="product-image">
                                                            <img src="{{ asset('backend_asset/images/product/1.png') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="best-product-box">
                                                        <div class="product-image">
                                                            <img src="{{ asset('backend_asset/images/product/2.png') }}"
                                                                class="img-fluid" alt="Product">
                                                        </div>
                                                        <div class="product-name">
                                                            <h5>Aata Buscuit</h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="best-product-box">
                                                        <div class="product-image">
                                                            <img src="{{ asset('backend_asset/images/product/3.png') }}"
                                                                class="img-fluid" alt="Product">
                                                        </div>
                                                        <div class="product-name">
                                                            <h5>Aata Buscuit</h5>
